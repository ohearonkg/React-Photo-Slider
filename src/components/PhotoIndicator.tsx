...
require('../styles/_photo-indicator.scss');
    ...
    return (
        <div className='photo-indicator'> 
            ...
            <div onClick={props.previousArrowClickFunction} className='photo-indicator__previous-arrow-container'>
                <svg width="16px" height="12px" viewBox="0 0 16 12" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <g id="Design" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        <g id="Home-Category" transform="translate(-293.000000, -955.000000)" fill="#1A212B" fillRule="nonzero">
            ...
            <div className='photo-indicator__text-container'>
                <span className='photo-indicator__current-photo-index'> {props.currentPhotoNumber < 10 ? '0' + props.currentPhotoNumber : props.currentPhotoNumber}</span><span className='photo-indicator__photo-count'> / {props.totalNumberPhotos < 10 ? '0' + props.totalNumberPhotos : props.totalNumberPhotos} </span>
            </div>

            <div onClick={props.nextArrowClickFunction} className='photo-indicator__next-arrow-container'>
                <svg width="16px" height="12px" viewBox="0 0 16 12" version="1.1" xmlns="http://www.w3.org/2000/svg">
                    <g id="Design" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        <g id="Home-Category" transform="translate(-373.000000, -955.000000)" fill="#1A212B" fillRule="nonzero">
                            <g id="Group-Copy" transform="translate(293.000000, 951.000000)">
