...
describe('Photo Indicator', () => {
    ...
    it('Should Take A Prop Representing The Currently Selected Photos Number And Render It', () => {
        const wrapper = shallow(<PhotoIndicator previousArrowClickFunction={ () => { return } } nextArrowClickFunction={ () => { return } } currentPhotoNumber={1} totalNumberPhotos={7}/>); 
    ...
    it('Should NOT Add A Zero In Front of The Number Representing The Currently Selected Photo Should It Be A Two Digit Number', () => {
        const wrapper = shallow(<PhotoIndicator previousArrowClickFunction={ () => { return } } nextArrowClickFunction={ () => { return } } currentPhotoNumber={11} totalNumberPhotos={7}/>); 
    ...
    it('Should NOT Add A Zero In Front of The Number Representing The Total Number of Photos Should It Be A Two Digit Number', () => {
        const wrapper = shallow(<PhotoIndicator previousArrowClickFunction={ () => { return } } nextArrowClickFunction={ () => { return } } currentPhotoNumber={1} totalNumberPhotos={77}/>); 
    ...
    it('Should Take As A Prop A Function Which Should Be Called When Clicking The Next Arrow', () => {
        ...
        const wrapper = shallow(<PhotoIndicator previousArrowClickFunction={ () => { return } } nextArrowClickFunction={nextArrowSampleFunction} currentPhotoNumber={1} totalNumberPhotos={77}/>); 
    ...
    it('Should Take As A Prop A Function Which Should Be Called When Clicking The Previous Arrow', () => {
        ...
        const wrapper = shallow(<PhotoIndicator previousArrowClickFunction={previousArrowSampleFunction} nextArrowClickFunction={ () => { return} } currentPhotoNumber={1} totalNumberPhotos={77}/>); 
        wrapper.find('.photo-indicator__previous-arrow-container').simulate('click');
